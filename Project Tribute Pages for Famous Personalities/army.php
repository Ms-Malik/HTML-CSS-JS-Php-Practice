                    ...
                    <div class="container">
                          <div class="inner-agile-w3l-part-head">
                            ...
                            <div class="ab-w3l-spa">
                             <img src="Pak army.jpg" width="2000" height="100" alt="" class="img-responsive" />
                             <p><b> OUR MOTTO IS</b></p>
                                <br><img src="army motto.png" alt="service-img">
...
@$db = new mysqli('localhost', $username, $password,$dsn);
 ...
 <table>
  ...
  while($stmt->fetch()) {
    ...
    <a href=""><img src="<?php echo $APic?>" alt="service-img"></a><h3><b><?php echo $AName?></b></h3><p><?php echo $ADesc?></p></td>
