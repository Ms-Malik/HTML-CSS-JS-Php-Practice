 ...
 <!--//main-header-->
	...
	<div class="breadcrumb-inner">	
			<ul>
				...
				<form action="pmashow.php" method="post">
 <p><strong></strong><br />
				...
				<div class="w3_content_agilleinfo_inner">
					<div class="container">
					      <div class="inner-agile-w3l-part-head">
					            <h2 class="w3l-inner-h-title">PAKISTAN ARMY</h2>
							</div>
							<div class="ab-w3l-spa">
							 <img src="jpg/Pak army.jpg" width="2000" height="100" alt="" class="img-responsive" />
                             <p><b> OUR MOTTO IS</b></p>
								<br><img src="jpg/army motto.png" alt="service-img">
...
@$db = new mysqli('localhost', $username, $password,$dsn);
 ...
 <table>
  ...
  while($stmt->fetch()) {
	...
	<a href="pmadetailsql.php"><img src="<?php echo $APic?>" alt="service-img"></a><h3><b><?php echo $AName?></b></h3><p><?php echo $ADesc?></p></td>
