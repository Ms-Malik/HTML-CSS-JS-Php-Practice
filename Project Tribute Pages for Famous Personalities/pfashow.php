...
<?php
                           ...
                           $searchtype=$_POST['searchtype'];
                            ...
                            $query = "SELECT APic, AName, ADesc FROM `airforce` WHERE ".$searchtype." LIKE '".$searchterm."%';";
 ...
 <!--//main-header-->
	...
	<div class="breadcrumb-inner">	
			<ul>
				...
				<li>Armed Force | PAK AIRFORCE</li>
			</ul>
		</div>
	</div>
<!-- //breadcrumb -->
				...
				<div class="w3_content_agilleinfo_inner">
					<div class="container">
					      <div class="inner-agile-w3l-part-head">
					            <h2 class="w3l-inner-h-title">PAKISTAN AIRFORCE</h2>
							</div>
							<table>
 <colgroup>
