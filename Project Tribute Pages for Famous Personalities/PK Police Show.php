...
<?php
                           ...
                           $searchtype=$_POST['searchtype'];
                            ...
                            $query = "SELECT PPic, PName, PDesc FROM `police1` WHERE ".$searchtype." LIKE '".$searchterm."%';";
                            $stmt = $db->prepare($query);
                            //$stmt->bind_param('s', $searchterm); 
                            $stmt->execute();
                            $stmt->store_result();
                            $stmt->bind_result($PPic, $PName, $PDesc);
                            echo "";
?>
<!DOCTYPE html>
<html>
...
<!-- //breadcrumb -->
 ...
 <?php
   ...
   while($stmt->fetch()) {
     ...
     <a href=""><img src="<?php echo $PPic?>" alt="service-img"></a><h3><b><?php echo $PName?></b></h3><p><?php echo $PDesc?></p></td>
