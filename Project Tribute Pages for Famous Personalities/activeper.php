<?php
 ...
 $password = "";
 $server="localhost";
@$db = new mysqli($server, $username, $password,$dsn);
...
<?php
                           ...
                           $searchtype=$_POST['searchtype'];
                            ...
                            $query = "SELECT APic, AName, ARank FROM `adata` WHERE ".$searchtype." LIKE '".$searchterm."%';";
                            $stmt = $db->prepare($query);
                            //$stmt->bind_param('s', $searchterm); 
                            $stmt->execute();
                            $stmt->store_result();
                            $stmt->bind_result($APic, $AName, $ARank);
                            echo "";
?>
<!DOCTYPE html>
<html>
				...
				<div class="w3_content_agilleinfo_inner">
					<div class="container">
					      <div class="inner-agile-w3l-part-head">
					            <h2 class="w3l-inner-h-title">ACTIVE STAR</h2>
							</div>
							<table>
 <colgroup>
